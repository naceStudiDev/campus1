...
const steps = [
  { number: '01', icon: '📝', title: 'Inscris-toi', description: 'Remplis le formulaire d\'inscription avec tes informations et choisis ta formation. C\'est rapide et gratuit.', color: '#4285F4' },
  { number: '02', icon: '📩', title: 'Reçois ton lien Google Meet', description: 'Après validation de ton inscription, tu reçois par email le lien de ta première session Google Meet.', color: '#EA4335' },
  { number: '03', icon: '📹', title: 'Assiste aux cours en direct', description: 'Connecte-toi aux sessions en direct depuis n\'importe où. Pose tes questions, interagis avec le prof et tes camarades.', color: '#34A853' },
  { number: '04', icon: '📈', title: 'Progresse à ton rythme', description: 'Accède aux replays des cours, fais des exercices pratiques et bénéficie d\'un suivi personnalisé.', color: '#FBBC05' },
]
    ...
    <>
      <section className="pt-32 pb-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">Simple, efficace, en ligne</h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-white font-black text-lg flex-shrink-0" style={{ backgroundColor: step.color }}>
                  {step.number}
                </div>
            ...
            <div className="bg-gray-900 rounded-3xl p-8 text-white">
              ...
              <div className="text-center mb-6">
                <p className="text-2xl font-black mb-2">
                  <span style={{ color: '#4285F4' }}>G</span><span style={{ color: '#EA4335' }}>o</span><span style={{ color: '#FBBC05' }}>o</span><span style={{ color: '#4285F4' }}>g</span><span style={{ color: '#34A853' }}>l</span><span style={{ color: '#EA4335' }}>e</span> Meet
                </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feat, i) => (
              <motion.div key={feat.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
